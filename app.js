...
const ORG = {
  ...
  'vjchilla': { name: 'Vijay kumar Chilla', title: 'Manager I, Risk Management', level: 4, isMgr: true, mgr: 'jorrigal', directs: ['sadiyk', 'rajamkr', 'ageethik', 'khanohsj', 'sarikabh', 'mchankit', 'gudimalh', 'apurwakr', 'kumunell', 'febinmah', 'kvinayt', 'rishiaj', 'sdayesha', 'abcdongr', 'purnah', 'judedmar', 'vagdevit', 'revardha', 'hrichikg'] },
  'sjjamwal': { name: 'Sjjamwal', title: 'Direct Report', level: 3, mgr: 'meghamav', directs: [] },
  'jhprakas': { name: 'Jhprakas', title: 'Direct Report', level: 3, mgr: 'meghamav', directs: [] },
  'apakalap': { name: 'Apakalap', title: 'Direct Report', level: 3, mgr: 'meghamav', directs: [] },
  'afnas': { name: 'Afnas', title: 'Direct Report', level: 3, mgr: 'meghamav', directs: [] },
  'ishratbq': { name: 'Ishratbq', title: 'Direct Report', level: 3, mgr: 'meghamav', directs: [] },
  'prabhanu': { name: 'Prabhanu', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'rishap': { name: 'Rishap', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'anjanvya': { name: 'Anjanvya', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'abhindas': { name: 'Abhindas', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'shreeru': { name: 'Shreeru', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'rosunews': { name: 'Rosunews', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'dutshirs': { name: 'Dutshirs', title: 'Direct Report', level: 3, mgr: 'kprasanj', directs: [] },
  'kalavags': { name: 'Kalavags', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'mithea': { name: 'Mithea', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'thonongi': { name: 'Thonongi', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'dachetha': { name: 'Dachetha', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'anuragys': { name: 'Anuragys', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'karnatij': { name: 'Karnatij', title: 'Direct Report', level: 3, mgr: 'yohannjo', directs: [] },
  'sadiyk': { name: 'Sadiyk', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'rajamkr': { name: 'Rajamkr', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'ageethik': { name: 'Ageethik', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'khanohsj': { name: 'Khanohsj', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'sarikabh': { name: 'Sarikabh', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'mchankit': { name: 'Mchankit', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'gudimalh': { name: 'Gudimalh', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'apurwakr': { name: 'Apurwakr', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'kumunell': { name: 'Kumunell', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'febinmah': { name: 'Febinmah', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'kvinayt': { name: 'Kvinayt', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'rishiaj': { name: 'Rishiaj', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'sdayesha': { name: 'Sdayesha', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'abcdongr': { name: 'Abcdongr', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'purnah': { name: 'Purnah', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'judedmar': { name: 'Judedmar', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'vagdevit': { name: 'Vagdevit', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'revardha': { name: 'Revardha', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  'hrichikg': { name: 'Hrichikg', title: 'Direct Report', level: 3, mgr: 'vjchilla', directs: [] },
  ...
  'gnneeraj': { name: 'Gnneeraj', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'ayabhatt': { name: 'Ayabhatt', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'nelluruk': { name: 'Nelluruk', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'paatreya': { name: 'Paatreya', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'apoogund': { name: 'Apoogund', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'ejawsury': { name: 'Ejawsury', title: 'Direct Report', level: 3, mgr: 'mssowmya', directs: [] },
  'prephani': { name: 'Prephani', title: 'Direct Report', level: 3, mgr: 'kgorapal', directs: [] },
  'kodsravy': { name: 'Kodsravy', title: 'Direct Report', level: 3, mgr: 'kgorapal', directs: [] },
  'bojjia': { name: 'Bojjia', title: 'Direct Report', level: 3, mgr: 'kgorapal', directs: [] },
  'goswapra': { name: 'Goswapra', title: 'Direct Report', level: 3, mgr: 'kgorapal', directs: [] },
  'kumamnik': { name: 'Kumamnik', title: 'Direct Report', level: 3, mgr: 'kgorapal', directs: [] },
